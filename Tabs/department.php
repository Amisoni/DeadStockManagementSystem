...
?>
<script>
    function updaterow(dept_id)
    {
        window.location.href = "../update_forms/department_update.php?dept_id=" + dept_id;
    }
    function deleterow(dept_id)
    {
        window.location.href = "../delete_controller/department_delete.php?dept_id=" + dept_id;
    }
</script>
                                        ...
                                        <table id="ks-datatable" class="table table-striped table-bordered" width="100%">
                                            ...
                                            if ($result) {
                                                while ($row = mysqli_fetch_array($result)) {
                                                    ...
                                                    . "<td>$row[dept_name]</td>"
                                                    . " <td> <i class='la la-pencil' onclick='updaterow($row[dept_id])' value='Update'></i> </td>"
                                                    . " <td> <i class='la la-trash' onclick='deleterow($row[dept_id])' value='Delete'> </i></td> </tr>";
                                                }
                                            }
                                            ?>
                                        </table>
                                    ...
                                    <div class="tab-pane" id="tab5" role="tabpanel">
                                        <form action="../controller/department_controller.php" method="post">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="dept_name" name="dept_name" placeholder="Add Department" required>
                                                </div>
                                            </div>
