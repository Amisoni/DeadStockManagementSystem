...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8">
        <title> DEAD STOCK MANAGEMENT </title>
            ...
            <div href="index.html" class="navbar-brand">
                ...
                <div class="ks-navbar-logo">
                    ...
                    <div class="col-md-2">
                        ...
                        <img class="centerMe" src="../images/clglogoo.jpg" alt="" style="height: 60px;width: 105px;"/> 
                    </div>
                    <div class="col-md-6 hide" style="margin-left: 80%; transform: translate(-50%, 0px);margin-top: 15px;color: red;">
                ...
                <nav class="nav navbar-nav">
                    ...
                    <div class="ks-user">
                        <a class="nav-link"  href="#" role="button" aria-haspopup="true" aria-expanded="false">
                            ...
                            &nbsp;<div class="ks-info">
                                <div class="ks-name"><?php echo ucwords($_SESSION['firstname']) . " " . ucwords($_SESSION['lastname']); ?></div>
                            </div>
                        </a>
